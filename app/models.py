...
class Open_position(models.Model):
    ...
    sl_order_id = models.CharField(max_length=50, choices=types, null=True, default=None)
    def __str__(self):
...
class Optimum_parameter(models.Model):
    ...
    winning_rate_month = models.FloatField(null=True, default=None)
    criteria = models.CharField(max_length=20, null=True, default=None)
    sl_low_limit = models.FloatField(null=True, default=None)
