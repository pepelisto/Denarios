...
import django
from bots.notUsed.A_A_invertido.functions.CryptoAnalyzer import CryptoAnalyzer
from bots.notUsed.A_A_invertido.functions.Take_position import BinanceTrader
import time
...
class Agripina:
    ...
    def traeder(self):
        symbols = Optimum_parameter.objects.filter(timeframe=self.timeframe).order_by('-pnl')
        for s in symbols:
