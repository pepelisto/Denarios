from bots.simulations.samples.Crypto_Get_samples.CryptoAnalyzerSimulatorBuy4_forcloseonly import CryptoAnalyzer
...
for s in symbols:
    ...
    combined_data_frame.to_csv(f"USDT7/5m/{s}_simulation.csv", index=False)
