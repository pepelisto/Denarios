...
def simulator():
    ...
    symbols = Symbol.objects.filter(find_in_api=True)[:5]
    for s in symbols:
        ...
        for v1 in [0]:
            ...
            for v2 in [0]:
                ...
                for v3 in [2]:
                    sl_tp_ratio = v3
                    for v5 in [0.004]:#, 0.007, 0.001]:# este quedo fijoo para siempre
                        sl_low_limit = v5
                        for v4 in [0.03]:#, 0.05, 0.01]:
                            sl_limit = v4
                            print(str(v3) + '  ' + str(v4))
